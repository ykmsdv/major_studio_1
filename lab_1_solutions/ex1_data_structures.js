...
addAMuseum(museums2, 'National Air and Space Museum', 'https://airandspace.si.edu/', 1946);

console.log(museums2);
console.log(museums2["American Museum of Natural History"]);